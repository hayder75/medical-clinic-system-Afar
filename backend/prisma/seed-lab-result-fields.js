...
const RESULT_FIELDS = {
  ...
  'UAKETON': [{ fieldName: 'ketones', label: 'Ketones', fieldType: 'select', options: ['Negative', 'Trace', '1+', '2+', '3+', '4+'], normalRange: 'Negative', displayOrder: 1 }],
  'UABILI': [{ fieldName: 'bilirubin', label: 'Bilirubin', fieldType: 'select', options: ['Negative', '1+', '2+', '3+'], normalRange: 'Negative', displayOrder: 1 }],
  'UAUROBIL': [{ fieldName: 'urobilinogen', label: 'Urobilinogen', fieldType: 'select', options: ['Negative', 'Positive', '1+', '2+', '3+'], normalRange: 'Negative', displayOrder: 1 }],
  ...
  'UAWBC': [{ fieldName: 'wbcHpf', label: 'WBC/HPF', fieldType: 'select', options: ['None', 'Few', 'Moderate', 'Many'], normalRange: 'None', displayOrder: 1 }],
  'UARBC': [{ fieldName: 'rbcHpf', label: 'RBC/HPF', fieldType: 'select', options: ['None', 'Few', 'Moderate', 'Many'], normalRange: 'None', displayOrder: 1 }],
  'UAEPI': [{ fieldName: 'epithelial', label: 'Epithelial Cells', fieldType: 'number', unit: '/LPF', normalRange: '0–5', displayOrder: 1 }],
  'UACRYST': [{ fieldName: 'crystals', label: 'Crystals', fieldType: 'select', options: ['None', 'Few', 'Moderate', 'Many'], normalRange: 'None', displayOrder: 1 }],
  'UABACT': [{ fieldName: 'bacteria', label: 'Bacteria', fieldType: 'select', options: ['None', 'Few', 'Moderate', 'Many'], normalRange: 'None', displayOrder: 1 }],
  'UACASTS': [{ fieldName: 'casts', label: 'Casts', fieldType: 'select', options: ['None', 'Few', 'Moderate', 'Many'], normalRange: 'None', displayOrder: 1 }],
